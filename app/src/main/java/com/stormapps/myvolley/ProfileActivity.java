...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String userName = intent.getStringExtra(DeveloperAdapter.KEY_NAME);
        String image = intent.getStringExtra(DeveloperAdapter.KEY_IMAGE);
        final String profileUrl = intent.getStringExtra(DeveloperAdapter.KEY_URL);
//Setting the views
